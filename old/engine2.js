...
hHtml += `<th class="py-3 px-3 text-right border-l border-stone-700 text-orange-400 w-[10%] bg-[#292524] shadow-sm">${Config.currency.name} (${Config.currency.symbol})</th>`;
...
tbody.innerHTML += `
            <tr class="${isBlk ? 'bg-red-950/40 border-l-4 border-red-500 grayscale transition opacity-80' : 'hover:bg-[#1c1917]/30 transition'}">
                <td class="py-4 px-3 border-r border-stone-700/80">
