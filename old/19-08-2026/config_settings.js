...
const GameSettings = {
    ...
    economy: {
        ...
        defaultPlayerCount: { value: 4, min: 1, max: 8, step: 1, label: "Standard-Spieleranzahl" }
    },
    ...
    roulette: {
        ...
        spinDurationMs: { value: 2100, min: 500, max: 5000, step: 100, label: "Rad-Animationsdauer (ms)" }
    },
    ...
    // 5. Scoring & Endabrechnung
    scoring: {
        synergyPointsPerTag: { value: 2, min: 0, max: 10, step: 1, label: "Synergie-Punkte (pro Duplikat)" },
        loserBonusFraction: { value: 0.15, min: 0.0, max: 0.50, step: 0.05, label: "Mitleids-Bonus für Letztplatzierten" }
    },
    ...
    ui: {
        ...
        auctionHammerDuration: { value: 1500, min: 500, max: 3000, step: 100, label: "Hammer-Animation (ms)" },
